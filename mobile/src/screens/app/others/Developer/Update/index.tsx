...
import { Content } from '~/screens/app/others/Developer/Update/components/Content'
import { Loader } from '~/screens/app/others/Developer/Update/components/Loader'

interface Route {
  developerId: string
}

const title = 'Alterar dados do(a) Dev.'

export function DeveloperUpdate() {
